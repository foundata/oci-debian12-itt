...
The sources are available at the [`foundata/oci-debian12-itt` repository](https://github.com/foundata/oci-debian12-itt). To build the image locally, do the following:
