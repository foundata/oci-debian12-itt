...
[Debian 12 (Bookworm)](https://www.debian.org/releases/bookworm/index.en.html) (Linux) for integration testing.
...
2. Clone or pull the latest changes from the [`foundata/oci-debian12-itt` git repository](https://github.com/foundata/oci-debian12-itt).
...
3. Run a container from the image:
   ```bash
   podman run --detach debian12-itt:latest
   ```
